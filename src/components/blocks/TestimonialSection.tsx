...
const testimonials = [
  {
    ...
    testimonial: "Coalbanks collected some drone footage for SMRID of larger canals and drop structures. Communication and scheduling was excellent and we were very pleased with the final product." // Updated full text
  },
  {
    name: "Rod Leland",
    ...
    testimonial: "I’ve worked with Coalbanks in a professional capacity and the agreed-upon creative brief led easily to exactly what we needed for our project quickly and with strong value."
  },
  {
    name: "Jason Visser",
    ...
    testimonial: "Michael was good to work with and went the extra mile to accommodate our school in helping us produce a promotional video that matched what we were looking for."
  }
]
